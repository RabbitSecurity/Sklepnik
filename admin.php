...
<ul>
	<li><a href='pregled.php?dogodek=<?php echo $dogodek_row->access_key; ?>'>Link za sprotno spremljanje rezultatov</a> (brez glasovanja)</li>
	<li><a href='pregled.php?dogodek=<?php echo $dogodek_row->access_key; ?>'>Seznam že postavljenih sklepov in rezultatov</a></li>
</ul>
...
Rezultate seveda lahko gledaš tudi naknadno <a href='rezultati.php?dogodek=<?php echo $dogodek_row->access_key; ?>'>tukaj</a>
<br/><br/>
...
<br>
Datum in čas začetka: <input type='text' name='time_start' value='<?php echo $dogodek_row->time_start; ?>'/><br/>
...
Št. delegatov: <input type='text' name='sklepcnost_min_delegatov' class='inputCenter' size='4' value='<?php echo $dogodek_row->sklepcnost_min_delegatov; ?>'/><br/>
Št. rodov: <input type='text' name='sklepcnost_min_rodov' class='inputCenter' size='4' value='<?php echo $dogodek_row->sklepcnost_min_rodov; ?>'/><br/>
Št. območji: <input type='text' name='sklepcnost_min_obmocji' class='inputCenter' size='4' value='<?php echo $dogodek_row->sklepcnost_min_obmocji; ?>'/><br/>
...
<div id='povezava' style='display:none;position:absolute;padding:10px;border:1px solid silver;background-color:#fff;'>
...
<br/>
<br/>
Format podatkov: Ime, Priimek, email, funkcija, rod, kratica rodu, območje, kratica območja (ločeno z vejico ali tab, en na vrstico).<br/>
Prva vrstica v datoteki(naslovna, z imeni stolpcev) bo izpuščena.<br/>
<br/>
Prenesi vzorčno datoteko <a href='delegati-tpl.xlsx'>tukaj</a>, uredi podatke in nato shrani kot .csv (CSV UTF-8).
<br/><br/>
